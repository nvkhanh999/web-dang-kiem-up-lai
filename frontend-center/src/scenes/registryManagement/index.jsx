   ...
   useEffect(() => {
    (async () => {
	  ...
	  const fetchData = await fetch(
		 "http://127.0.0.1:8000/registry/center/" + localStorage.getItem("centerID"), requestOptions,
	  );
	...
	useEffect(() => {
		(async () => {
			...
			const fetchData = await fetch(
				"http://127.0.0.1:8000/registry/month/" + localStorage.getItem("centerID"),
				requestOptions,
			);
		...
		useEffect(() => {
			(async () => {
				...
				const fetchData = await fetch(
					"http://127.0.0.1:8000/registry/quarter/" + localStorage.getItem("centerID"),
					requestOptions,
				);
		...
		useEffect(() => {
			(async () => {
				...
				const fetchData = await fetch(
					"http://127.0.0.1:8000/registry/year/" + localStorage.getItem("centerID"),
					requestOptions,
				);
		...
		useEffect(() => {
			(async () => {
				...
				const fetchData = await fetch(
					"http://127.0.0.1:8000/registry/almostExpired/" + localStorage.getItem("centerID"),
					requestOptions,
				);
